                    ...
                    <div className='row '>
                        <div className='col-4'>
                            ...
                            <h3 className={`${style.h3textCata} mt-3 mt-lg-2 mt-xl-3 mt-sm-0 ml-2`}>Изготовление мебели
                                на заказ</h3>
                            <p className={`${style.ptextCata} ml-2 mt-3 mb-3 mt-lg-2 mt-xl-4 mt-sm-0 mb-3 mb-lg-2 mb-xl-4`}>Создаем
                    ...
                    <div className='row '>
                        ...
                        <div className='col-8 '>
                            <h3 className={`${style.h3textDesign} mt-3 mt-lg-2 mt-xl-3 mt-sm-1 ml-2`}>Дизайн
                                интерьера</h3>
                            <p className={`${style.ptextCata} w-50 ml-2 mt-3 mb-3 mt-lg-2 mt-xl-4 mt-sm-0 mb-3 mb-lg-2 mb-xl-4`}>Создаем
                                уникальные интерьеры и мебель премиум класса в
                                Москве</p>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-5 '>
                            <h3 className={`${style.h3textCata} mt-3 mt-lg-2 mt-xl-3 mt-sm-1 ml-2`}>Исторические
                                копии</h3>
                            <p className={`${style.ptextCata} ml-2 ml-2 mt-3 mb-3 mt-lg-2 mt-xl-4 mt-sm-0 mb-3 mb-lg-2 mb-xl-4`}>Создаем
                                уникальные интерьеры и мебель премиум класса в
                                Москве</p>
                            <button className={`${style.btnCata1} ml-2`}>перейти</button>
                        </div>
